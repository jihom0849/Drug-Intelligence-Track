...
def get_public_link_url() -> str:
    for env_name in ("APP_WEBSITE_URL", "PUBLIC_LINK_URL"):
        value = os.getenv(env_name)
        if value and value.strip():
            return value.strip()

    config_path = "public_link.txt"
